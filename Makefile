...
lint:
	$(PYTHON) -m compileall apps/control-api/app apps/control-api/tests forecasting/timesfm experiments/inference-autoscaling observability/otel-genai governance/cost governance/approval
