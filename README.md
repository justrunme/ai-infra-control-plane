...
Images are signed with cosign and accompanied by an SPDX SBOM artifact from the release workflow. Tag releases with `v*` (for example `v1.0.0`) to publish semver tags. Current release line: **v1.6.0**.
